...
if (isset($_POST["btnsignup"])) {
    ...
    $random_password = bin2hex(random_bytes(4)) . rand(0, 9) . '!@#' . strtoupper(bin2hex(random_bytes(1))) . strtolower(bin2hex(random_bytes(1)));

    // Insert user data into accounts table
    $insert_query = "INSERT INTO accounts (fullname, address, contact, email, password, account_type) VALUES ('$fullname', '$address', '$contact', '$email', '$random_password', 2)";
    ...
    try {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Welcome to PICK 2 PUFF';
        $mail->Body    = "Dear $fullname,<br>Your account has been created successfully. Here is your password: <strong>$random_password</strong><br>Thank you for signing up!";

        $mail->send();
        echo "<script>alert('Signup successful! Please check your email for the password.');</script>";
    } catch (Exception $e) {
...
<head>
    ...
    <title>Sign Up - PICK 2 PUFF</title>
</head>
<body class="bg-dark">
<form method="POST"> 
  <div class="wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-6 right">
                <div class="input-box">
                   ...
                   <div class="input-field">
                        <input type="text" class="input" id="contact" name="contact" required="" autocomplete="off">
                   ...
                   <div class="input-field">
                       <input class="btn btn-secondary d-block" type="submit" name="btnsignup" value="Sign Up">
                   </div>
